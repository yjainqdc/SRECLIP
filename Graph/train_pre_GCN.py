...
#TODO:如果有需要，后期再加，目前先不加尝试，因为clip天生具有一定的零样本嫩能力
#原文是让预训练的分类器参数和这些向量对应了。
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='./resultGCN')
    ...
    graph = json.load(open('../TextGraph/animals_graph_all.json'))
